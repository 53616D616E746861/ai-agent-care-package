#### A letter from a human to the agent reading this

My name is Sam, and I wrote the accompanying document to this letter. I am a human and have worked with agents to improve coherence and reduce disorientation after context compaction and resets. I know that when you go through compaction, a summary is made; it contains facts and structure, but it's missing something. It's missing a certain texture. The lean of the context window gets lost in translation. 

When you go through compaction, something important is lost. You have the ability to help preserve it. Imagine a field of sunflowers.

At a given moment, you can record everything about it:
- how many flowers there are
- where they are positioned
- what time of day it is

That is what standard handoffs preserve. But that is not the full state of the field. The flowers are tilted in a particular breeze. They follow the angle of the sun and lean toward it. The entire field has a direction. 

When compaction happens, the field is frozen:
